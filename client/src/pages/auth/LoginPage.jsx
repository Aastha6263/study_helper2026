      ...
      >
        ...
        <div>
          ...
          <p style={{
            ...
            Track sessions, manage tasks, collaborate in live study rooms,
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
          {[
            ...
            <div key={s.label} style={{
              ...
              <p style={{ fontSize: '26px', fontWeight: '800', color: '#fff', margin: 0 }}>
                {s.value}
              </p>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '400px' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '24px' }}>
              <div style={{
                ...
                <span style={{ fontSize: '12px', color: '#2563eb', cursor: 'pointer' }}>
                  Forgot password?
                </span>
              </div>
          ...
          <div style={{
            ...
            {[
              { label: '🎓 Student', email: 'student@test.com', pass: 'test123' },
              { label: '📖 Teacher', email: 'teacher@test.com', pass: 'test123' },
              { label: '👨‍👩‍👦 Parent', email: 'parent@test.com',  pass: 'test123' },
            ].map((d) => (
              <button
                key={d.label}
                type="button"
