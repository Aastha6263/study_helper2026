  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-blue-100 via-white to-indigo-100">
      ...
      <div className="flex gap-3 mb-4">
        <button onClick={() => setMode("create")} className="bg-blue-500 text-white px-4 py-2 rounded">Create</button>
        <button onClick={() => setMode("study")} className="bg-green-500 text-white px-4 py-2 rounded">Study</button>
      </div>
      ...
      {mode === "study" && cards.length > 0 && (
        ...
        <div className="space-y-6">
          ...
          >
            <div className={`relative w-full h-full transition-transform duration-500 transform ${flipped ? "rotate-y-180" : ""}`}>
          ...
          <div className="flex justify-center gap-3">
            <button onClick={prevCard} className="px-3 py-1 bg-gray-300 rounded">Prev</button>
            <button onClick={nextCard} className="px-3 py-1 bg-gray-300 rounded">Next</button>
          </div>

          {/* SELF ASSESS */}
          <div className="flex justify-center gap-3">
            <button onClick={() => rate("again")} className="bg-red-500 text-white px-3 py-1 rounded">Again</button>
            <button onClick={() => rate("hard")} className="bg-yellow-500 text-white px-3 py-1 rounded">Hard</button>
            <button onClick={() => rate("good")} className="bg-blue-500 text-white px-3 py-1 rounded">Good</button>
            <button onClick={() => rate("easy")} className="bg-green-500 text-white px-3 py-1 rounded">Easy</button>
          </div>
